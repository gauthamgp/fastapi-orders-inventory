...
from app.vectorstore_utils import create_faiss_index,retreive_similar_documents
    ...
    if st.session_state.vectorstore and st.session_state.chat_model:
        with st.chat_message("assistant"):
            with st.spinner("🔍 Searching documents..."):
                ...
                relevant_docs = retreive_similar_documents(st.session_state.vectorstore, prompt)
